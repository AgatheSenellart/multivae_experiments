...
training_config = BaseTrainerConfig(
    per_device_train_batch_size=256, num_epochs=500, learning_rate=1e-3
)
...
for sampler in samplers:
    ...
    module_eval = CoherenceEvaluator(
        model, load_mmnist_classifiers(), test_set, eval_config=config, sampler=sampler
    )
...
lik_module = LikelihoodsEvaluator(
    model,
    test_set,
    output=output_dir,
